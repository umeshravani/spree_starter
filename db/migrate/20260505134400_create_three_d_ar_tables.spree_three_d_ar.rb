...
class CreateThreeDArTables < ActiveRecord::Migration[7.1] # Check your exact Rails version
  def change
    # 1. Categories
    create_table :spree_three_d_categories do |t|
      t.string :name
      t.timestamps
    end

    # 2. Models
    create_table :spree_three_d_models do |t|
      t.string :name
    ...
    create_table :spree_three_d_materials do |t|
      t.string :mesh_name
    ...
    create_table :spree_product_three_d_overrides do |t|
    ...
    add_reference :spree_products, :three_d_model, foreign_key: { to_table: :spree_three_d_models }
  end
end